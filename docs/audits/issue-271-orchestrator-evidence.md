...
A presença desse arquivo permite vincular o conteúdo ao workflow, ao run e ao SHA efetivamente executado. O nome externo do artefato não substitui a attestation interna.
...
- a auditoria deve conferir que `headSha` coincide com o SHA congelado;
