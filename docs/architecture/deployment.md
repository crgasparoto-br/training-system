...
- `DEFAULT_CONTRACT_ID`: contrato preferencial da clonagem completa na tela Empresa / prestador. E opcional; se estiver ausente, apontar para o proprio contrato alvo ou nao possuir dados clonaveis, a API ignora o valor e aplica o ranking automatico documentado em `docs/architecture/api.md`.
