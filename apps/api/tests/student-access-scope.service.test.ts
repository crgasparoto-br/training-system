...
describe('studentAccessScopeService', () => {
  ...
  it('allows a professor to access their own aluno', async () => {
    await expect(
      studentAccessScopeService.assertAlunoAccess('student-1', professorContext, prisma)
  ...
  it('denies another professor aluno within the same company contract', async () => {
    ...
    await expect(
      studentAccessScopeService.assertAlunoAccess('student-2', professorContext, prisma)
