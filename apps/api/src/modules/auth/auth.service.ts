...
export class AuthService {
  ...
  async register(data: RegisterRequest): Promise<AuthResponse> {
    ...
    const { user, professor, contractId } = await prisma.$transaction(async (tx) => {
      ...
      if (!managerFunction) {
        throw new Error('N�o foi poss�vel preparar as fun��es padr�o do contrato');
      }
        ...
        professor: professor
          ? {
              ...
              contract: {
                ...
                tradeName: professor.contract.tradeName,
                cref: professor.contract.cref,
                addressStreet: professor.contract.addressStreet,
                addressNumber: professor.contract.addressNumber,
                addressNeighborhood: professor.contract.addressNeighborhood,
                addressCity: professor.contract.addressCity,
                addressState: professor.contract.addressState,
                addressComplement: professor.contract.addressComplement,
                addressZipCode: professor.contract.addressZipCode,
                logoUrl: professor.contract.logoUrl,
              },
            }
          : null,
      },
        ...
        professor: user.professor
          ? {
              ...
              contract: {
                ...
                tradeName: user.professor.contract.tradeName,
                cref: user.professor.contract.cref,
                addressStreet: user.professor.contract.addressStreet,
                addressNumber: user.professor.contract.addressNumber,
                addressNeighborhood: user.professor.contract.addressNeighborhood,
                addressCity: user.professor.contract.addressCity,
                addressState: user.professor.contract.addressState,
                addressComplement: user.professor.contract.addressComplement,
                addressZipCode: user.professor.contract.addressZipCode,
                logoUrl: user.professor.contract.logoUrl,
              },
            }
          : null,
      },
  ...
  async requestPasswordReset(email: string): Promise<ForgotPasswordResponse> {
    ...
    const genericMessage =
      'Se existir uma conta com este e-mail, voc� receber� as instru��es para redefinir a senha.';
  ...
  async resetPassword(data: ResetPasswordRequest): Promise<ResetPasswordResponse> {
    ...
    if (!decoded?.userId || decoded.purpose !== 'password-reset') {
      throw new Error('Token de recupera��o inv�lido ou expirado');
    }
