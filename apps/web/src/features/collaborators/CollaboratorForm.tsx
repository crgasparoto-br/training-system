    ...
    <div className="space-y-5">
      <CollaboratorSection title="Identificação e contato" description="Dados usados para identificar e contatar o colaborador.">
        <div className="grid gap-5 xl:grid-cols-[220px_minmax(0,1fr)]">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            />
            <Input label="Telefone" {...register('phone')} error={errorMessage(errors.phone)} />
            <Input label="Data de nascimento" type="date" {...register('birthDate')} error={errorMessage(errors.birthDate)} />
            <Input label="CPF" {...register('cpf')} error={errorMessage(errors.cpf)} />
            <Input label="RG" {...register('rg')} error={errorMessage(errors.rg)} />
      ...
      <CollaboratorSection title="Endereço" description="Informações para cadastro e documentos.">
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          <Input label="Estado" maxLength={2} {...register('addressState')} error={errorMessage(errors.addressState)} />
      ...
      <CollaboratorSection title="Perfil profissional" description="Função, vínculo, experiência e responsabilidades.">
        <div className="grid gap-4 md:grid-cols-2">
          <Input label="Instagram" {...register('instagramHandle')} error={errorMessage(errors.instagramHandle)} />
          ...
          <Input label="Data de desligamento" type="date" disabled={!administrativeFieldsEnabled} {...register('dismissalDate')} error={errorMessage(errors.dismissalDate)} />
      ...
      <CollaboratorSection title="Dados jurídicos e financeiros" description="Dados para contratação e pagamento.">
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          <Input label="CNPJ / documento da empresa" {...register('companyDocument')} error={errorMessage(errors.companyDocument)} />
          ...
          <Input label="Conta" {...register('bankAccount')} error={errorMessage(errors.bankAccount)} />
      ...
      <CollaboratorSection title="Remuneração" description="Valores por frente de atuação.">
        <div className="grid gap-4 md:grid-cols-3">
          <Input label="Personal (R$/hora)" inputMode="decimal" disabled={!administrativeFieldsEnabled} {...register('hourlyRates.personal')} />
          <Input label="Consultoria (R$/hora)" inputMode="decimal" disabled={!administrativeFieldsEnabled} {...register('hourlyRates.consulting')} />
          <Input label="Avaliação (R$/hora)" inputMode="decimal" disabled={!administrativeFieldsEnabled} {...register('hourlyRates.evaluation')} />
        </div>
      </CollaboratorSection>
