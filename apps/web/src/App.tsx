...
import { AlunoFormWithContractPreview } from './pages/AlunoFormWithContractPreview';
    ...
    <AppErrorBoundary>
      <BrowserRouter>
        ...
        >
          ...
          <Route path="alunos/:id/edit" element={withAccess('students.registration', <AlunoFormWithContractPreview />)} />
